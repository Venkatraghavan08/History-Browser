...
class App extends Component {
  ...
  FillFunction = value => {
    ...
    if (newHistoryList.length === 0) {
      this.setState({latestHistoryList: newHistoryList, isShow: true})
    } else {
  ...
  render() {
    ...
    const newHistoryList = latestHistoryList.filter(eachItem =>
...
/>
            ...
            <div className="search-holder">
                <img className="https://assets.ccbp.in/frontend/react-js/search-img.png " 
                src="search-icon" alt="search"/>
                <input type="search"
        ...
        <div className="content=holder">
            {!isShow && (
                <ul className="inner-holder">
                    ...
                    uniqueId={eachObject.id}>
                        ...
                        type="button" onClick={()=>this.FillFunction(eachObject.id)}>
                            <img className="delete-icon" 
                            src="https://assets.ccbp.in/frontend/react-js/delete-img.png " alt="delete"/>
                        </button>
                    </li>
                        )}
                </ul>
            ...
            {isTrue && (
                <div className="empty-container">
                    <p className="empty-elements">There is no history to show</p>
                </div>
            )}
        </div>
      </div>
